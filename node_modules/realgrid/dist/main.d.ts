...
declare type AfterCallback = (index: CellIndex) => void;
...
declare type BeforeCallback = (index: CellIndex) => boolean;
...
declare type ButtonVisibleCallback = (grid: GridBase, index: any, focused: boolean, mouseEntered: boolean) => boolean;
 ...
 * ```
 */
export declare class ColumnFooter extends ColumnSummary {
 ...
 */
export declare class ColumnFooterCollection {
...
export declare type ColumnGroupSummaryCallback = (grid: any, column: any, footerIndex: number, model: any, value: any) => void;
 ...
 * ```
 */
export declare class ColumnHeader extends ColumnObject {
 ...
 * {@link ColumnObject} - {@link ColumnSummary}
 */
export declare class ColumnHeaderSummary extends ColumnSummary {
    constructor(column: GridColumn);
 ...
 */
export declare class ColumnHeaderSummaryCollection {
 ...
 */
export declare abstract class ColumnObject {
 ...
 */
export declare abstract class ColumnSummary extends ColumnObject {
...
export declare interface CustomCellRenderer {
     ...
     * ```js
     * grid.registerCustomRenderer("renderer01", {
     *      render: function(grid, model, bcel, w, h) {
     *           let span = this._span;
     *
     *           // text설정.
     ...
     * ```
     */
    render?: (grid: any, model: GridCell, bcell: BodyTableCell, w: number, h: number) => void;
    /**
 ...
 */
export declare class DataColumn extends ValueColumn {
     ...
     * @eventProperty
     */
    get displayCallback(): any;
    set displayCallback(value: any);
     ...
     */
    get filters(): any | ColumnFilterCollection;
     ...
     */
    get errorLevel(): ValidationLevel;
    set errorLevel(value: ValidationLevel);
    /**
...
export declare interface DataField {
     ...
     * @example
     * ```js
     * dataField.valueCallback = function (dataRow, fieldName, fieldNames, values) {
...
export declare interface DisplayOptions {
     ...
     *
     * @remarks
     * {@link EditOptions.movable} 도 `true` 일 때, alt 키와 함께 드래그하여 이동시킬 수 있다.
     *
     * @defaultValue `false`
     */
    rowMovable?: boolean;
...
declare class FilterSelector extends EventAware {
    ...
    private get doc();
    constructor(container: GridContainer, options: FilteringOptions, grid: GridBase);
...
export declare abstract class GridBase {
    ...
    constructor(container: string | HTMLDivElement, accessibility?: boolean);
 ...
 * - {@link SeriesColumn}
 */
export declare abstract class GridColumn {
 ...
 * ```
 */
export declare class SeriesColumn extends ValueColumn {
 ...
 * {@link ValueColumn}
 */
export declare class ValueColumn extends GridColumn {
     ...
     * {@link CellEditor} 참조
     */
    get editor(): CellEditor;
    set editor(value: CellEditor);
    /**
     * 데이터 셀 우측에 표시할 버튼
     *
